...
class Contactable : public PhysicsBody {
public:
	explicit Contactable(SKMath::vec3 origin, SKMath::quat orientation, std::string modelPath, float modelScale, StardustXRFusion::Field &field);
